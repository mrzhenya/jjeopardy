 ...
 */
public class FlatMacDarkTheme extends LafTheme {

  /** Theme ID. */
  public static final LafThemeId LAF_THEME_ID = LafThemeId.FLAT_MAC_DARK;

  /** Class name of this LAF to use with UIManager. */
  public static final String LAF_CLASS_NAME = "com.formdev.flatlaf.themes.FlatMacDarkLaf";
  ...
  public static final Color GAME_TABLE_HEADER_BACKGROUND_COLOR = new Color(23, 29, 67);

  /** Game table border color. */
  public static final Color GAME_TABLE_BORDER_COLOR = new Color(40, 40, 40);
  ...
  public boolean activateTheme() {
    FlatMacDarkLaf theme = new FlatMacDarkLaf();
    boolean result = FlatMacDarkLaf.setup(theme);
