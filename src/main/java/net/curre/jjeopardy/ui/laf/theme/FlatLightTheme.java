...
public class FlatLightTheme extends LafTheme {
  ...
  private static final Color GAME_TABLE_CELL_TEXT_COLOR = new Color(89, 55, 1);

  private static final Color GAME_TABLE_HEADER_TEXT_COLOR = new Color(3, 3, 63);

  /** Default game table cell background image. */
  private static final Image GAME_TABLE_CELL_BACKGROUND_DEFAULT = ImageEnum.CELL_LIGHT.toImage();

  /** Hover game table cell background image. */
  private static final Image GAME_TABLE_CELL_BACKGROUND_HOVER = ImageEnum.CELL_LIGHT_HOVER.toImage();

  /** Empty game table cell background image. */
  private static final Image GAME_TABLE_CELL_BACKGROUND_EMPTY = ImageEnum.CELL_LIGHT_EMPTY.toImage();

  /** Game table header background color. */
  private static final Color GAME_TABLE_HEADER_BACKGROUND_COLOR = new Color(198, 211, 246);

  /** Game table player score background color. */
  private static final Color GAME_TABLE_SCORE_PANEL_BACKGROUND_COLOR = new Color(218, 225, 245);
  ...
  public Color getGameTableHeaderColor() {
    return GAME_TABLE_HEADER_TEXT_COLOR;
  }
  ...
  public Color getGameTableScorePlayerBackground() {
    return GAME_TABLE_SCORE_PANEL_BACKGROUND_COLOR;
  }
}
