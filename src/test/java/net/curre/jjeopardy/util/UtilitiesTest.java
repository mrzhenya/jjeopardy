...
public class UtilitiesTest {
  ...
  /** Tests getDefaultIntProperty. */
  @Test
  public void testGetDefaultIntProperty() {
    int minValue = Utilities.getDefaultIntProperty("jj.defaults.categories.min");
    assertTrue("Int property value should be > 0.", minValue > 0);
  }
}
